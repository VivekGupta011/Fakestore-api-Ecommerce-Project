        ...
        <div>
            <Navbar bg="light" variant="dark">
                <Container>
                    ...
                    <Navbar.Brand href="#home"><Link to="/cart" style={{textDecoration:"none",color:"black",fontWeight:500}}><button className='btn custom-btn btn-outline-dark '><img src={cart} style={{width:"20px"}}/>({Count})</button></Link></Navbar.Brand>
                    </Nav>
                </Container>
            </Navbar>
        </div>
